...
LANG = {
    ...
    'de': {
        ...
        'status_more_tweet': '%d Zeichen zu viel. Tweet wird geteilt.',
        'status_more_message': '%d Zeichen zu viel. Nachricht wird geteilt.',
    ...
    'en': {
        ...
        'status_more_tweet': 'Plus %d char(s). Tweet will be split.',
        'status_more_message': 'Plus %d char(s). Message will be split.',
